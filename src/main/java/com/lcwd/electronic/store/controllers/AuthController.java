...
//	private String newPassword;
	...
	@GetMapping("/current")
	public ResponseEntity<UserDto> getCurentUser(Principal principal){
		
		String name = principal.getName();
		
		return new ResponseEntity<UserDto>(modelMapper.map(userDetailsService.loadUserByUsername(name), UserDto.class),HttpStatus.OK);
	}
...
//		
//		 Builder verifire = new GoogleIdTokenVerifier.Builder(netHttpTransport, jacksonFactory).setAudience(Collections.singleton(googleClientId));
//		 
//		 
...
//		 
//		 //till here we verified to user and get details of the user
//		 //now we have to do work related to our project that is check weather that user is in database or not
//		 //if not create one if have then go respectively
//		 
//		 User user=null;
